...
export const useChatSession = (
  ...
  const handleSendPress = async (message: MessageType.PartialText) => {
    ...
    try {
      // The Pal UI can advertise talents before the store's async
      // initialization has populated the runtime registry. Ensure the
      // executor is ready at the exact point where a tool call may arrive.
      registerDefaultTalents();
