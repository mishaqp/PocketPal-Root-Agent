...
import {TermuxEngine} from './TermuxEngine';
import {TaskCheckpointEngine} from './TaskCheckpointEngine';
import {ScheduledAgentEngine} from './ScheduledAgentEngine';
...
export {TermuxEngine} from './TermuxEngine';
export {TaskCheckpointEngine} from './TaskCheckpointEngine';
export {ScheduledAgentEngine} from './ScheduledAgentEngine';
...
export function registerDefaultTalents(): void {
  ...
  talentRegistry.register(new TermuxEngine());
  talentRegistry.register(new TaskCheckpointEngine());
  talentRegistry.register(new ScheduledAgentEngine());
