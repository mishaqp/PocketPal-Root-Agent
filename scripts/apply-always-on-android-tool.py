...
# 3) Make Android runtime identity explicit. Termux and task_checkpoint contribute
# their own prompt fragments whenever present in the resolved tools list.
...
print("Applied always-on android_system + termux + task_checkpoint wiring and Android runtime bootstrap")
