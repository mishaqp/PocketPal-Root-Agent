...
# 3) Make Android runtime identity explicit. Termux/task_checkpoint/scheduled_agent
# contribute their own prompt fragments whenever present in the resolved tools list.
...
print("Applied always-on android_system + termux + task_checkpoint + scheduled_agent wiring and Android runtime bootstrap")
